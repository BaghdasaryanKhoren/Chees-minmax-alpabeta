...
namespace SrcChess2 {
    ...
    public partial class CircularProgressBar {
        ...
        public CircularProgressBar() {
            ...
            m_animationTimer.Interval   = TimeSpan.FromMilliseconds(500);
        }
        ...
        public int SpeedInMS {
            get {
                return((int)m_animationTimer.Interval.TotalMilliseconds);
            }
            set {
                m_animationTimer.Interval = TimeSpan.FromMilliseconds(value);
            }
        }
        ...
        private void HandleAnimationTick(object sender, EventArgs e) {
            SpinnerRotate.Angle = (SpinnerRotate.Angle + 18) % 360;
        }
